...
goog.exportSymbol('proto.marsproto.ReadResponse.GamePhase', null, global);
 ...
 * @const
 */
proto.marsproto.ServerMessage.oneofGroups_ = [[100,101,102,103]];
...
proto.marsproto.ServerMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    readResponse: (f = msg.getReadResponse()) && proto.marsproto.ReadResponse.toObject(includeInstance, f)
  };
...
proto.marsproto.ServerMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 102:
      ...
      break;
    case 103:
      var value = new proto.marsproto.ReadResponse;
      reader.readMessage(value,proto.marsproto.ReadResponse.deserializeBinaryFromReader);
...
proto.marsproto.ServerMessage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      103,
      f,
      proto.marsproto.ReadResponse.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional ReadResponse read_response = 103;
 * @return {?proto.marsproto.ReadResponse}
 */
proto.marsproto.ServerMessage.prototype.getReadResponse = function() {
  return /** @type{?proto.marsproto.ReadResponse} */ (
    jspb.Message.getWrapperField(this, proto.marsproto.ReadResponse, 103));
};


/**
 * @param {?proto.marsproto.ReadResponse|undefined} value
 * @return {!proto.marsproto.ServerMessage} returns this
*/
proto.marsproto.ServerMessage.prototype.setReadResponse = function(value) {
  return jspb.Message.setOneofWrapperField(this, 103, proto.marsproto.ServerMessage.oneofGroups_[0], value);
};
 ...
 * @return {!proto.marsproto.ServerMessage} returns this
 */
proto.marsproto.ServerMessage.prototype.clearReadResponse = function() {
  return this.setReadResponse(undefined);
};
 ...
 * @return {boolean}
 */
proto.marsproto.ServerMessage.prototype.hasReadResponse = function() {
...
proto.marsproto.ReadResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    phase: jspb.Message.getFieldWithDefault(msg, 50, 0),
...
proto.marsproto.ReadResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 50:
      var value = /** @type {!proto.marsproto.ReadResponse.GamePhase} */ (reader.readEnum());
      msg.setPhase(value);
      break;
    case 100:
 ...
 * @enum {number}
 */
proto.marsproto.ReadResponse.GamePhase = {
  NONE_PHASE: 0,
  BEFORE_START: 1,
  INITIATING: 2,
  DURING_GENERATION: 3,
...
/**
 * optional GamePhase phase = 50;
 * @return {!proto.marsproto.ReadResponse.GamePhase}
 */
proto.marsproto.ReadResponse.prototype.getPhase = function() {
  return /** @type {!proto.marsproto.ReadResponse.GamePhase} */ (jspb.Message.getFieldWithDefault(this, 50, 0));
};


/**
 * @param {!proto.marsproto.ReadResponse.GamePhase} value
 * @return {!proto.marsproto.ReadResponse} returns this
 */
proto.marsproto.ReadResponse.prototype.setPhase = function(value) {
