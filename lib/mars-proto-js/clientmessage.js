...
proto.marsproto.ClientMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
    actresp: (f = msg.getActresp()) && proto.marsproto.ActionResponse.toObject(includeInstance, f),
    readreq: (f = msg.getReadreq()) && proto.marsproto.ReadRequest.toObject(includeInstance, f)
  };
...
/**
 * optional ActionResponse actResp = 100;
 * @return {?proto.marsproto.ActionResponse}
 */
proto.marsproto.ClientMessage.prototype.getActresp = function() {
...
*/
proto.marsproto.ClientMessage.prototype.setActresp = function(value) {
 ...
 * @return {!proto.marsproto.ClientMessage} returns this
 */
proto.marsproto.ClientMessage.prototype.clearActresp = function() {
  return this.setActresp(undefined);
};
 ...
 * @return {boolean}
 */
proto.marsproto.ClientMessage.prototype.hasActresp = function() {
  return jspb.Message.getField(this, 100) != null;
};


/**
 * optional ReadRequest readReq = 101;
 * @return {?proto.marsproto.ReadRequest}
 */
proto.marsproto.ClientMessage.prototype.getReadreq = function() {
 ...
 * @return {!proto.marsproto.ClientMessage} returns this
*/
proto.marsproto.ClientMessage.prototype.setReadreq = function(value) {
 ...
 * @return {!proto.marsproto.ClientMessage} returns this
 */
proto.marsproto.ClientMessage.prototype.clearReadreq = function() {
  return this.setReadreq(undefined);
};
 ...
 * @return {boolean}
 */
proto.marsproto.ClientMessage.prototype.hasReadreq = function() {
